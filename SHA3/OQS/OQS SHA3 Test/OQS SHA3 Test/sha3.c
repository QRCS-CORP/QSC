...
static void OQS_SHA3_keccak_absorb(uint64_t* state, size_t rate, const uint8_t* input, size_t inplen, uint8_t domain)
{
	uint8_t msg[200];
	size_t i;
...
static void OQS_SHA3_keccak_squeezeblocks(uint8_t* output, size_t nblocks, uint64_t* state, size_t rate)
{
	size_t i;
...
void OQS_SHA3_compute256(uint8_t* output, const uint8_t* message, size_t msglen)
{
	uint64_t state[OQS_SHA3_STATESIZE];
	uint8_t hash[OQS_SHA3_256_RATE];
	size_t i;
	...
	OQS_SHA3_keccak_absorb(state, OQS_SHA3_256_RATE, message, msglen, OQS_SHA3_DOMAIN);
	OQS_SHA3_keccak_squeezeblocks(hash, 1, state, OQS_SHA3_256_RATE);
...
void OQS_SHA3_compute512(uint8_t* output, const uint8_t* message, size_t msglen)
{
	uint64_t state[OQS_SHA3_STATESIZE];
	uint8_t hash[OQS_SHA3_512_RATE];
	size_t i;
	...
	OQS_SHA3_keccak_absorb(state, OQS_SHA3_512_RATE, message, msglen, OQS_SHA3_DOMAIN);
	OQS_SHA3_keccak_squeezeblocks(hash, 1, state, OQS_SHA3_512_RATE);
...
void OQS_SHA3_blockupdate(uint64_t* state, size_t rate, const uint8_t* message, size_t msgoffset, size_t msglen)
{
	size_t i;
...
void OQS_SHA3_finalize(uint64_t* state, size_t rate, const uint8_t* message, size_t msgoffset, size_t msglen, uint8_t* output)
{
	uint8_t msg[200];
	size_t i;

	OQS_SHA3_blockupdate(state, rate, message, msgoffset, msglen);
...
void OQS_SHA3_shake128(uint8_t* output, size_t outlen, const uint8_t* seed, size_t seedlen)
{
	size_t nblocks = outlen / OQS_SHA3_SHAKE128_RATE;
	uint64_t state[OQS_SHA3_STATESIZE];
	uint8_t hash[OQS_SHA3_SHAKE128_RATE];
	size_t i;
	...
	OQS_SHA3_keccak_absorb(state, OQS_SHA3_SHAKE128_RATE, seed, seedlen, OQS_SHA3_SHAKE_DOMAIN);
	OQS_SHA3_keccak_squeezeblocks(output, nblocks, state, OQS_SHA3_SHAKE128_RATE);
	...
	if (outlen != 0)
	{
		OQS_SHA3_keccak_squeezeblocks(hash, 1, state, OQS_SHA3_SHAKE128_RATE);
...
void OQS_SHA3_shake128_absorb(uint64_t* state, const uint8_t* seed, size_t seedlen)
{
	OQS_SHA3_keccak_absorb(state, OQS_SHA3_SHAKE128_RATE, seed, seedlen, OQS_SHA3_SHAKE_DOMAIN);
}
...
void OQS_SHA3_shake256(uint8_t* output, size_t outlen, const uint8_t* seed, size_t seedlen)
{
	size_t nblocks = outlen / OQS_SHA3_SHAKE256_RATE;
	uint64_t state[OQS_SHA3_STATESIZE];
	uint8_t hash[OQS_SHA3_SHAKE256_RATE];
	size_t i;
	...
	OQS_SHA3_keccak_absorb(state, OQS_SHA3_SHAKE256_RATE, seed, seedlen, OQS_SHA3_SHAKE_DOMAIN);
	OQS_SHA3_keccak_squeezeblocks(output, nblocks, state, OQS_SHA3_SHAKE256_RATE);
	...
	if (outlen != 0)
	{
		OQS_SHA3_keccak_squeezeblocks(hash, 1, state, OQS_SHA3_SHAKE256_RATE);
...
void OQS_SHA3_shake256_absorb(uint64_t* state, const uint8_t* seed, size_t seedlen)
{
	OQS_SHA3_keccak_absorb(state, OQS_SHA3_SHAKE256_RATE, seed, seedlen, OQS_SHA3_SHAKE_DOMAIN);
}
...
void OQS_SHA3_cshake128_simple(uint8_t* output, size_t outlen, uint16_t cstm, const uint8_t* seed, size_t seedlen)
{
	...
	OQS_SHA3_cshake128_simple_absorb(state, cstm, seed, seedlen);
...
void OQS_SHA3_cshake128_simple_absorb(uint64_t* state, uint16_t cstm, const uint8_t* seed, size_t seedlen)
{
	...
	/* absorb the state */
	OQS_SHA3_keccak_absorb(state, OQS_SHA3_CSHAKE128_RATE, seed, seedlen, OQS_SHA3_CSHAKE_DOMAIN);
}
...
void OQS_SHA3_cshake256_simple(uint8_t* output, size_t outlen, uint16_t cstm, const uint8_t* seed, size_t seedlen)
{
	...
	OQS_SHA3_cshake256_simple_absorb(state, cstm, seed, seedlen);
...
void OQS_SHA3_cshake256_simple_absorb(uint64_t* state, uint16_t cstm, const uint8_t* seed, size_t seedlen)
{
	uint8_t sep[8];
	sep[0] = 0x01; /* bytepad */
	sep[1] = 0x88;
	...
	/* absorb the state */
	OQS_SHA3_keccak_absorb(state, OQS_SHA3_CSHAKE256_RATE, seed, seedlen, OQS_SHA3_CSHAKE_DOMAIN);
}
