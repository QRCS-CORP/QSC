...
// */
//void sphincsplus_sign_seed_keypair(uint8_t* pk, uint8_t* sk, const uint8_t* seed);

///**
// * Returns an array containing a detached signature.
// */
//void sphincsplus_sign_signature(uint8_t* sig, size_t* siglen, const uint8_t* m, size_t mlen, const uint8_t* sk);
