...
* \date August 15, 2020
*
* \brief <b>n implementation of an cSHAKE Generator DRBG: CSG</b> \n
...
* qsc_csg_initialize(seed, 32, info, 32, true);
*
...
*
* \remarks
* <p>CSG uses the Keccak cSHAKE generator to produce pseudo-random bytes from a seeded custom SHAKE generator. \n
...
#define QSC_BCG256_SEED_SIZE 64
#define QSC_BCG512_SEED_SIZE 96
#define QSC_BCG_RESEED_THRESHHOLD 1024000
...
typedef struct
{
	...
	uint8_t nonce[32];				/*!< The nonce or initialization vector */
    uint8_t cache[160];
    size_t bctr;
    size_t cpos;
    size_t crmd;
...
*
* \param seed: The random seed, 64 bytes of seed material
...
* \warning Initialize must first be called before this function can be used.
*
* \param seed: The random update seed
