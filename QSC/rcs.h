...
* ...
* uint8_t cpt[MSGLEN + QSC_RCS256_MAC_LENGTH] = { 0 };
* qsc_rcs_state state;
...
* const size_t MSGLEN = CPTLEN - QSC_RCS256_MAC_LENGTH;
...
/*!
* \def QSC_RCS256_MAC_LENGTH
* \brief The RCS-256 MAC code array length in bytes.
*/
#define QSC_RCS256_MAC_LENGTH 32
...
/*!
* \def QSC_RCS512_MAC_LENGTH
* \brief The RCS-512 MAC code array length in bytes.
*/
#define QSC_RCS512_MAC_LENGTH 64
