...
\hypertarget{encoding_8h_source}{}\label{encoding_8h_source}\index{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/encoding.h@{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/encoding.h}}
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ }
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#ifndef\ QSC\_ENCODING\_H}}
\DoxyCodeLine{00042\ \textcolor{preprocessor}{\#define\ QSC\_ENCODING\_H}}
\DoxyCodeLine{00043\ }
\DoxyCodeLine{00044\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{common_8h}{common.h}}"{}}}
\DoxyCodeLine{00045\ }
\DoxyCodeLine{00046\ \textcolor{comment}{/*}}
\DoxyCodeLine{00047\ \textcolor{comment}{*\ \(\backslash\)file\ encoding.h}}
\DoxyCodeLine{00048\ \textcolor{comment}{*\ \(\backslash\)brief\ This\ file\ contains\ base64\ and\ RAD\ encoding\ functions}}
\DoxyCodeLine{00049\ \textcolor{comment}{*/}}
\DoxyCodeLine{00050\ }
\DoxyCodeLine{00060\ QSC\_EXPORT\_API\ \textcolor{keywordtype}{bool}\ qsc\_encoding\_base64\_decode(uint8\_t*\ output,\ \textcolor{keywordtype}{size\_t}\ otplen,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ input,\ \textcolor{keywordtype}{size\_t}\ inlen);}
\DoxyCodeLine{00061\ }
\DoxyCodeLine{00069\ QSC\_EXPORT\_API\ \textcolor{keywordtype}{size\_t}\ qsc\_encoding\_base64\_decoded\_size(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ input,\ \textcolor{keywordtype}{size\_t}\ length);}
\DoxyCodeLine{00070\ }
\DoxyCodeLine{00079\ QSC\_EXPORT\_API\ \textcolor{keywordtype}{void}\ qsc\_encoding\_base64\_encode(\textcolor{keywordtype}{char}*\ output,\ \textcolor{keywordtype}{size\_t}\ otplen,\ \textcolor{keyword}{const}\ uint8\_t*\ input,\ \textcolor{keywordtype}{size\_t}\ inplen);}
\DoxyCodeLine{00080\ }
\DoxyCodeLine{00087\ QSC\_EXPORT\_API\ \textcolor{keywordtype}{size\_t}\ qsc\_encoding\_base64\_encoded\_size(\textcolor{keywordtype}{size\_t}\ length);}
\DoxyCodeLine{00088\ }
\DoxyCodeLine{00095\ QSC\_EXPORT\_API\ \textcolor{keywordtype}{bool}\ qsc\_encoding\_base64\_is\_valid\_char(\textcolor{keywordtype}{char}\ value);}
\DoxyCodeLine{00096\ }
