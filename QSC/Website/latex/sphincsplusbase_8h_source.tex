\doxysection{sphincsplusbase.\+h}
\hypertarget{sphincsplusbase_8h_source}{}\label{sphincsplusbase_8h_source}\index{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/sphincsplusbase.h@{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/sphincsplusbase.h}}
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ }
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#ifndef\ QSC\_SPHINCSPLUSBASE\_H}}
\DoxyCodeLine{00042\ \textcolor{preprocessor}{\#define\ QSC\_SPHINCSPLUSBASE\_H}}
\DoxyCodeLine{00043\ }
...
\DoxyCodeLine{00049\ }
\DoxyCodeLine{00053\ \textcolor{keywordtype}{size\_t}\ sphincsplus\_ref\_sign\_secretkeybytes(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00054\ }
\DoxyCodeLine{00058\ \textcolor{keywordtype}{size\_t}\ sphincsplus\_ref\_sign\_publickeybytes(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00059\ }
\DoxyCodeLine{00063\ \textcolor{keywordtype}{size\_t}\ sphincsplus\_ref\_sign\_bytes(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00064\ }
\DoxyCodeLine{00068\ \textcolor{keywordtype}{size\_t}\ sphincsplus\_ref\_sign\_seedbytes(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00069\ }
\DoxyCodeLine{00077\ int32\_t\ sphincsplus\_ref\_generate\_seed\_keypair(uint8\_t*\ pk,\ uint8\_t*\ sk,\ \textcolor{keyword}{const}\ uint8\_t*\ seed);}
\DoxyCodeLine{00078\ }
\DoxyCodeLine{00086\ \textcolor{keywordtype}{void}\ sphincsplus\_ref\_generate\_keypair(uint8\_t*\ pk,\ uint8\_t*\ sk,\ \textcolor{keywordtype}{bool}\ (*rng\_generate)(uint8\_t*,\ \textcolor{keywordtype}{size\_t}));}
\DoxyCodeLine{00087\ }
\DoxyCodeLine{00098\ \textcolor{keywordtype}{void}\ sphincsplus\_ref\_sign\_signature(uint8\_t*\ sig,\ \textcolor{keywordtype}{size\_t}*\ siglen,\ \textcolor{keyword}{const}\ uint8\_t*\ m,\ \textcolor{keywordtype}{size\_t}\ mlen,\ \textcolor{keyword}{const}\ uint8\_t*\ sk,\ \textcolor{keywordtype}{bool}\ (*rng\_generate)(uint8\_t*,\ \textcolor{keywordtype}{size\_t}));}
\DoxyCodeLine{00099\ }
\DoxyCodeLine{00110\ \textcolor{keywordtype}{bool}\ sphincsplus\_ref\_sign\_verify(\textcolor{keyword}{const}\ uint8\_t*\ sig,\ \textcolor{keywordtype}{size\_t}\ siglen,\ \textcolor{keyword}{const}\ uint8\_t*\ m,\ \textcolor{keywordtype}{size\_t}\ mlen,\ \textcolor{keyword}{const}\ uint8\_t*\ pk);}
\DoxyCodeLine{00111\ }
\DoxyCodeLine{00122\ \textcolor{keywordtype}{void}\ sphincsplus\_ref\_sign(uint8\_t*\ sm,\ \textcolor{keywordtype}{size\_t}*\ smlen,\ \textcolor{keyword}{const}\ uint8\_t*\ m,\ \textcolor{keywordtype}{size\_t}\ mlen,\ \textcolor{keyword}{const}\ uint8\_t*\ sk,\ \textcolor{keywordtype}{bool}\ (*rng\_generate)(uint8\_t*,\ \textcolor{keywordtype}{size\_t}));}
\DoxyCodeLine{00123\ }
\DoxyCodeLine{00134\ \textcolor{keywordtype}{bool}\ sphincsplus\_ref\_sign\_open(uint8\_t*\ m,\ \textcolor{keywordtype}{size\_t}*\ mlen,\ \textcolor{keyword}{const}\ uint8\_t*\ sm,\ \textcolor{keywordtype}{size\_t}\ smlen,\ \textcolor{keyword}{const}\ uint8\_t*\ pk);}
\DoxyCodeLine{00135\ }
\DoxyCodeLine{00136\ \textcolor{comment}{/*\ \(\backslash\)endcond\ DOXYGEN\_IGNORE\ */}}
\DoxyCodeLine{00137\ }
