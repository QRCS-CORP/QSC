\doxysection{dilithiumbase\+\_\+avx2.\+h}
\hypertarget{dilithiumbase__avx2_8h_source}{}\label{dilithiumbase__avx2_8h_source}\index{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/dilithiumbase\_avx2.h@{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/dilithiumbase\_avx2.h}}
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ }
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#ifndef\ QSC\_DILITHIUMBASE\_AVX2\_H}}
\DoxyCodeLine{00042\ \textcolor{preprocessor}{\#define\ QSC\_DILITHIUMBASE\_AVX2\_H}}
\DoxyCodeLine{00043\ }
...
\DoxyCodeLine{00047\ }
\DoxyCodeLine{00056\ \textcolor{keywordtype}{void}\ qsc\_dilithium\_avx2\_generate\_keypair(uint8\_t*\ pk,\ uint8\_t*\ sk,\ \textcolor{keywordtype}{bool}\ (*rng\_generate)(uint8\_t*,\ \textcolor{keywordtype}{size\_t}));}
\DoxyCodeLine{00057\ }
\DoxyCodeLine{00068\ \textcolor{keywordtype}{void}\ qsc\_dilithium\_avx2\_sign\_signature(uint8\_t*\ sig,\ \textcolor{keywordtype}{size\_t}*\ siglen,\ \textcolor{keyword}{const}\ uint8\_t*\ m,\ \textcolor{keywordtype}{size\_t}\ mlen,\ \textcolor{keyword}{const}\ uint8\_t*\ sk,\ \textcolor{keywordtype}{bool}\ (*rng\_generate)(uint8\_t*,\ \textcolor{keywordtype}{size\_t}));}
\DoxyCodeLine{00069\ }
\DoxyCodeLine{00080\ \textcolor{keywordtype}{void}\ qsc\_dilithium\_avx2\_sign(uint8\_t*\ sm,\ \textcolor{keywordtype}{size\_t}*\ smlen,\ \textcolor{keyword}{const}\ uint8\_t*\ m,\ \textcolor{keywordtype}{size\_t}\ mlen,\ \textcolor{keyword}{const}\ uint8\_t*\ sk,\ \textcolor{keywordtype}{bool}\ (*rng\_generate)(uint8\_t*,\ \textcolor{keywordtype}{size\_t}));}
\DoxyCodeLine{00081\ }
\DoxyCodeLine{00092\ \textcolor{keywordtype}{bool}\ qsc\_dilithium\_avx2\_verify(\textcolor{keyword}{const}\ uint8\_t*\ sig,\ \textcolor{keywordtype}{size\_t}\ siglen,\ \textcolor{keyword}{const}\ uint8\_t*\ m,\ \textcolor{keywordtype}{size\_t}\ mlen,\ \textcolor{keyword}{const}\ uint8\_t*\ pk);}
\DoxyCodeLine{00093\ }
\DoxyCodeLine{00104\ \textcolor{keywordtype}{bool}\ qsc\_dilithium\_avx2\_open(uint8\_t*\ m,\ \textcolor{keywordtype}{size\_t}*\ mlen,\ \textcolor{keyword}{const}\ uint8\_t*\ sm,\ \textcolor{keywordtype}{size\_t}\ smlen,\ \textcolor{keyword}{const}\ uint8\_t*\ pk);}
\DoxyCodeLine{00105\ }
\DoxyCodeLine{00106\ \textcolor{comment}{/*\ \(\backslash\)endcond\ DOXYGEN\_IGNORE\ */}}
\DoxyCodeLine{00107\ }
