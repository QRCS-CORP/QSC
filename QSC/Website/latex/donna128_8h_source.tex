\doxysection{donna128.\+h}
\hypertarget{donna128_8h_source}{}\label{donna128_8h_source}\index{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/donna128.h@{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/donna128.h}}
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ }
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#ifndef\ QSC\_DONNA128\_H}}
\DoxyCodeLine{00042\ \textcolor{preprocessor}{\#define\ QSC\_DONNA128\_H}}
\DoxyCodeLine{00043\ }
\DoxyCodeLine{00044\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{common_8h}{common.h}}"{}}}
\DoxyCodeLine{00045\ }
\DoxyCodeLine{00046\ \textcolor{comment}{/*}}
\DoxyCodeLine{00047\ \textcolor{comment}{*\ \(\backslash\)file\ donna128.h}}
\DoxyCodeLine{00048\ \textcolor{comment}{*\ \(\backslash\)brief\ Donna\ function\ definitions}}
\DoxyCodeLine{00049\ \textcolor{comment}{*/}}
\DoxyCodeLine{00050\ }
\DoxyCodeLine{00055\ QSC\_EXPORT\_API\ \textcolor{keyword}{typedef}\ \textcolor{keyword}{struct}}
\DoxyCodeLine{00056\ \{}
\DoxyCodeLine{00057\ \ \ \ \ uint64\_t\ \mbox{\hyperlink{structuint128_a9997109464efa7a7fc24efcaca7a9fb3}{high}};\ \ }
\DoxyCodeLine{00058\ \ \ \ \ uint64\_t\ \mbox{\hyperlink{structuint128_a8325b33af041490126f231fdfd194797}{low}};\ \ \ \ }
\DoxyCodeLine{00059\ \}\ \mbox{\hyperlink{structuint128}{uint128}};}
\DoxyCodeLine{00060\ }
\DoxyCodeLine{00068\ QSC\_EXPORT\_API\ \mbox{\hyperlink{structuint128}{uint128}}\ qsc\_donna128\_shift\_right(\textcolor{keyword}{const}\ \mbox{\hyperlink{structuint128}{uint128}}*\ x,\ \textcolor{keywordtype}{size\_t}\ shift);}
\DoxyCodeLine{00069\ }
\DoxyCodeLine{00077\ QSC\_EXPORT\_API\ \mbox{\hyperlink{structuint128}{uint128}}\ qsc\_donna128\_shift\_left(\textcolor{keyword}{const}\ \mbox{\hyperlink{structuint128}{uint128}}*\ x,\ \textcolor{keywordtype}{size\_t}\ shift);}
\DoxyCodeLine{00078\ }
\DoxyCodeLine{00086\ QSC\_EXPORT\_API\ uint64\_t\ qsc\_donna128\_andl(\textcolor{keyword}{const}\ \mbox{\hyperlink{structuint128}{uint128}}*\ x,\ uint64\_t\ mask);}
\DoxyCodeLine{00087\ }
\DoxyCodeLine{00095\ QSC\_EXPORT\_API\ uint64\_t\ qsc\_donna128\_andh(\textcolor{keyword}{const}\ \mbox{\hyperlink{structuint128}{uint128}}*\ x,\ uint64\_t\ mask);}
\DoxyCodeLine{00096\ }
\DoxyCodeLine{00104\ QSC\_EXPORT\_API\ \mbox{\hyperlink{structuint128}{uint128}}\ qsc\_donna128\_add(\textcolor{keyword}{const}\ \mbox{\hyperlink{structuint128}{uint128}}*\ x,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{structuint128}{uint128}}*\ y);}
\DoxyCodeLine{00105\ }
\DoxyCodeLine{00113\ QSC\_EXPORT\_API\ \mbox{\hyperlink{structuint128}{uint128}}\ qsc\_donna128\_multiply(\textcolor{keyword}{const}\ \mbox{\hyperlink{structuint128}{uint128}}*\ x,\ uint64\_t\ y);}
\DoxyCodeLine{00114\ }
\DoxyCodeLine{00122\ QSC\_EXPORT\_API\ \mbox{\hyperlink{structuint128}{uint128}}\ qsc\_donna128\_or(\textcolor{keyword}{const}\ \mbox{\hyperlink{structuint128}{uint128}}*\ x,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{structuint128}{uint128}}*\ y);}
\DoxyCodeLine{00123\ }
