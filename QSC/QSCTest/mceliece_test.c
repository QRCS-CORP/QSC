...
bool qsctest_mceliece_kat_test()
{
	...
	qsctest_hex_to_bin("9583F9C0E887851BE079E0AEF65CC7F6C11482AA537E99EAD8865C3B5E65821468C4687CDF017C9FCF2B318238A97519"
	...
	qsctest_hex_to_bin("DD1A7EC5E1026D5A77210F1374219018FC1C6CFD6BADF848A860C4749424D344", expss, sizeof(expss));
	qsctest_hex_to_bin("061550234D158C5EC95595FE04EF7A25767F2E24CC2BC479D09D86DC9ABCFDE7056A8C266F9EF97ED08541DBD2E1FFA1", seed, sizeof(seed));
#elif defined(QSC_MCELIECE_N6960T119)
	qsctest_hex_to_bin("056DACA18318D82849759ED3C816C45821186E6AA763A018C5A40AA29593A6C312A30CE36FB3C30BC4E2A4AFD1C7B065"
	...
	qsctest_hex_to_bin("179C2314367D02DCC0CF1C1CCF7055FB870CB26F529BBD4A393D6603FE70AE95", expss, sizeof(expss));
	qsctest_hex_to_bin("061550234D158C5EC95595FE04EF7A25767F2E24CC2BC479D09D86DC9ABCFDE7056A8C266F9EF97ED08541DBD2E1FFA1", seed, sizeof(seed));
#else
