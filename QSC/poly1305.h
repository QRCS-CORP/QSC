...
*/
typedef struct qsc_poly1305_state
{
	uint32_t h[5];
	uint32_t k[4];
	uint32_t r[5];
...
*/
void qsc_poly1305_finalize(qsc_poly1305_state* ctx, uint8_t* mac);
...
* \param key: [const] The secret key byte array
*/
int qsc_poly1305_verify(const uint8_t* output, const uint8_t* message, size_t msglen, const uint8_t* key);
