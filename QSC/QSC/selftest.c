...
#	if defined(QSC_CSX_KPA_AUTHENTICATION)
	...
	hex_to_bin("F726CF4BECEBDFDE9275C54B5284D0CDEEF158D8E146C027B731B6EF852C008F"
		...
		"232860BAA2491A8C5759EBD3BA8D88831A94F6E093067ABC38BAC5DA1FFBCDFF"
		"83876A96979A43FF412EFC2649B3DB1950539BBAD3025E08454F8743081BF4E6", exp1, sizeof(exp1));
	hex_to_bin("379E86BCE2F0BE6DF0BAA8FEC403C6A7244B21D1D5B9193FCE79510FF2633893"
		...
		"8BC0FC88BCB2B0877C8B24E000C290D1C843254580F276550E86E9004263287B"
		"2D4BEE64C61B77DEF6CAAA6F99B450A947B8310E2D1BDC94238A1AF13C55345F", exp2, sizeof(exp2));
#	else
	/* csxc512k512 */
	hex_to_bin("F726CF4BECEBDFDE9275C54B5284D0CDEEF158D8E146C027B731B6EF852C008F"
		"842B15CD0DCF168F93C9DE6B41DEE964D62777AA999E44C6CFD903E65E0096EF"
		...
		"BBF27CC741CE602E32C7ACC0BA37C3DC129872B915A09307F301E882B745D51E", exp1, sizeof(exp1));
	hex_to_bin("379E86BCE2F0BE6DF0BAA8FEC403C6A7244B21D1D5B9193FCE79510FF2633893"
		"F58D57DABBEF0424E1E8D5ED7B485EB7381CC7235350220CA03F1D107A102BD3"
		"5FAB74869AB656D35E0F40950E1564DBDC37ECFD6C50BEE201BFA0F953AEC0A2"
		"9B063993F5D019CDDE4A8AA02D440C19A4A08AD7A0CD3F2FDFEF61D0383314B5"
		"78DD157DC0173AD4D71840C3078D37829AD9FBFA89969F5C48F5D19BB70B7019"
		"454FFE01D4D14D3C677A42DCD7302F3B2486BAF216A125B04043DC10549ED157", exp2, sizeof(exp2));
#	endif
...
#	if defined(QSC_RCS_KPA_AUTHENTICATION)
	/* rcsc256p256 */
	hex_to_bin("7940917E9219A31248946F71647B15421535941574F84F79F6110C1F2F776D03"
		"9D502A200A7B7D7271E5E193CB8EE26A83DD4920F6851E815129DEFD14FCC691", exp1, sizeof(exp1));
	hex_to_bin("ABF3574126DAA563B423B0EEEE9970FD0C8F060F65CB00CDC05BB0DC047DB2AD"
		"3824E58C648418D67CD5CC0A5B7872D1A5EACD0E2AC38894454F3376E2208281", exp2, sizeof(exp2));
#	else
	/* rcsc256k256 */
	hex_to_bin("7940917E9219A31248946F71647B15421535941574F84F79F6110C1F2F776D03"
		"EBC24989F5DC4F8598BF155E24944745E52B7DC27161CA3D9DB7951647F41DB8", exp1, sizeof(exp1));
	hex_to_bin("ABF3574126DAA563B423B0EEEE9970FD0C8F060F65CB00CDC05BB0DC047DB2AD"
		"A45F363A919EE677C9C1C7478A63E78E0C66AB17078AEC4E30C6B9063BB20B68", exp2, sizeof(exp2));
#	endif
	memset(ad, 0x01, sizeof(ad));
...
#	if defined(QSC_RCS_KPA_AUTHENTICATION)
	...
	hex_to_bin("21E97A126E35BE731EF204E48248A2EEB01B692992F73786602F21031FBFB7C8"
		...
		"5FF2A85B9F56D85506AF47F3892F132D86F3E8E58E9A3CC1C45221F948AADA3B"
		"8675D6593891132F4282BA501A21DBD21800408330114AB541CDD663D8E82096", exp1, sizeof(exp1));
	hex_to_bin("388270BF8DF03483BB287FFA527D81403F0362210FD525657C8541250DFFE3BA"
		...
		"A5DC8731B4290F9CE19B41E2D11FDED18429FEFFA89B11127DC1EC484B2500AF"
		"8260CEA4AD805B8528A422862E1D5AE36435F57D32BAA6375305EE3445AF9504", exp2, sizeof(exp2));
#	else
	/* rcsc512k512 */
	hex_to_bin("21E97A126E35BE731EF204E48248A2EEB01B692992F73786602F21031FBFB7C8"
		"A1CF250F2EC948D5985B92667349B72EFA751048AF0B919AE9E16F177F5C97F2"
		"CA4C3AF6D1BF2FA8694483FC1F429A7ECC7C9B5F6FCB8504265DE0385B4D012A"
		"8E11035F172C98090549B38FA4B0525ED747EE9670B240C1EC3C2E03070E3E11", exp1, sizeof(exp1));
	hex_to_bin("388270BF8DF03483BB287FFA527D81403F0362210FD525657C8541250DFFE3BA"
		"D1285FAB37A6821DA524F3F7FF7EFCB39C5B59E3897B177E45D6AA7F4BB5BE77"
		"F8A3206DD873100E1CC7AD430EDB01A4D464EAE2DB23BF310E53C65A1AABDC92"
		"D0F1F64D9A427447296475CA9429F715967863ED209715453FA48030E43C7C35", exp2, sizeof(exp2));
#	endif
	memset(ad, 0x01, sizeof(ad));
	memcpy(ncpy, nce, sizeof(nce));
#else
