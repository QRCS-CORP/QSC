...
//bool qsc_p256_key_exchange(uint8_t* sharedsecret, const uint8_t* privatekey, const uint8_t* publickey)
//{
...
//    ret = -1;
//
//    if (sharedsecret == NULL || privatekey == NULL || publickey == NULL)
//    {
//        ret = -1;
//    }
//    else
//    {
//        qsc_memutils_clear(sharedsecret, 32);
//
//        qsc_sha256_compute(hash, privatekey, 32);
//        sc_from_bytes_reduce(d, hash);
//
//        if (fe256_is_zero(d) != 0U)
//        {
...
//            fe256_from_bytes(Q.Y, publickey + 32U);
//
//            if (p256_point_is_on_curve(&Q) == false)
//            {
//                ret = -3;
//            }
//            else
...
//                else
//                {
//                    fe256_to_bytes(sharedsecret, S.X);
//                    ret = 0;
//                }
//            }
//        }
...
//    qsc_memutils_clear(d, sizeof(d));
//    qsc_memutils_clear(&Q, sizeof(Q));
//    qsc_memutils_clear(&S, sizeof(S));
//    qsc_memutils_clear(&J, sizeof(J));
//
//    return (ret == 0);
//}
