...
/*!
 * \brief Tests the encoding functions for validity, safety, and correct output.
 *
 * \return          [bool] Returns true if encoding tests succeeded; false if any of the tests fail.
 */
QSC_EXPORT_API bool qsc_encoding_tests();
#endif
