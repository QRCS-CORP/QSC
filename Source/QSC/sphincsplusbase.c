...
static void sphincsplus_thash_x1(uint8_t* out, const uint8_t* in, const uint8_t* pubseed, uint32_t addr[8U])
{
    ...
    uint8_t blkbuf[SPX_N + SPX_N + SPX_ADDR_BYTES] = { 0U };
    uint8_t bitmask[SPX_N];
...
static void sphincsplus_thash_x2(uint8_t* out, const uint8_t* in, const uint8_t* pubseed, uint32_t addr[8U])
{
    ...
    uint8_t blkbuf[(2U * SPX_N) + SPX_N + SPX_ADDR_BYTES] = { 0U };
    uint8_t bitmask[(2U * SPX_N)] = { 0U };
...
static void sphincsplus_thash_fors(uint8_t* out, const uint8_t* in, const uint8_t* pubseed, uint32_t addr[8U])
{
    ...
    uint8_t blkbuf[(SPX_FORS_TREES * SPX_N) + SPX_N + SPX_ADDR_BYTES] = { 0U };
    uint8_t bitmask[(SPX_FORS_TREES * SPX_N)] = { 0U };
...
static void sphincsplus_thash_wots(uint8_t* out, const uint8_t* in, const uint8_t* pubseed, uint32_t addr[8U])
{
    ...
    uint8_t blkbuf[(SPX_WOTS_LEN * SPX_N) + SPX_N + SPX_ADDR_BYTES] = { 0U };
    uint8_t bitmask[(SPX_WOTS_LEN * SPX_N)] = { 0U };
    ...
    uint32_t tree_addr[8U])
{
    ...
    uint32_t heights[SPX_TREE_HEIGHT + 1U] = { 0U };
    uint8_t stack[(SPX_TREE_HEIGHT + 1U) * SPX_N] = { 0U };
    uint32_t offset;
    uint32_t tree_idx;
    ...
    uint32_t tree_addr[8U])
{
    ...
    uint32_t heights[SPX_FORS_HEIGHT + 1U] = { 0U };
    uint8_t stack[(SPX_FORS_HEIGHT + 1U) * SPX_N] = { 0U };
    uint32_t offset;
    uint32_t tree_idx;
...
static void sphincsplus_fors_sign(uint8_t* sig, uint8_t* pk, const uint8_t* m, const uint8_t* sk_seed, const uint8_t* pubseed, const uint32_t fors_addr[8U])
{
    ...
    uint8_t roots[SPX_FORS_TREES * SPX_N] = { 0U };
