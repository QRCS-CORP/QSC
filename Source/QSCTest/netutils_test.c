...
static bool qsctest_address_info()
{
	...
	QSC_SIMD_ALIGN char dom[QSC_NETUTILS_HOSTS_NAME_SIZE] = { 0 };
	QSC_SIMD_ALIGN char saddv4[QSC_IPINFO_IPV4_STRNLEN] = { 0 };
	QSC_SIMD_ALIGN char saddv6[QSC_IPINFO_IPV6_STRNLEN] = { "1"};
	char portc[] = "80";
	char protc[] = "http";
	size_t len;
	uint16_t port;
