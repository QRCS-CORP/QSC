...
#ifndef QSCTEST_TLS_STAGE18_0RTT_RESUMPTION_TESTS_H
#define QSCTEST_TLS_STAGE18_0RTT_RESUMPTION_TESTS_H
...
/**
 * \brief Execute the TLS Stage 18 test set.
 *
 * \details This function runs the Stage 18 tests using the QSC test harness
 ...
 *
 * \return Returns true if all Stage 18 tests succeed.
 */
