...
static void secure_expand(rsx_state* state, rsx_keyparams* keyparams)
{
	...
	if (state->rkeylen == RSX256_ROUNDKEY_DIMENSION)
	{
		...
		cshake256(rk, (RSX256_ROUNDKEY_DIMENSION * ROUNDKEY_ELEMENT_SIZE), keyparams->key, keyparams->keylen, NULL, 0, keyparams->dcode, keyparams->codelen);
	...
	else
	{
		...
		cshake256(rk, (RSX512_ROUNDKEY_DIMENSION * ROUNDKEY_ELEMENT_SIZE), keyparams->key, keyparams->keylen, NULL, 0, keyparams->dcode, keyparams->codelen);
...
static void secure_expand(rsx_state* state, rsx_keyparams* keyparams)
{
	cshake256((uint8_t*)state->roundkeys, state->rkeylen * sizeof(uint32_t), keyparams->key, keyparams->keylen, NULL, 0, keyparams->dcode, keyparams->codelen);
}
