\doxysection{falcon.\+h}
\hypertarget{falcon_8h_source}{}\label{falcon_8h_source}\index{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/falcon.h@{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/falcon.h}}
\mbox{\hyperlink{falcon_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ }
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#ifndef\ QSC\_FALCON\_H}}
\DoxyCodeLine{00042\ \textcolor{preprocessor}{\#define\ QSC\_FALCON\_H}}
\DoxyCodeLine{00043\ }
\DoxyCodeLine{00077\ }
\DoxyCodeLine{00078\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{common_8h}{common.h}}"{}}}
\DoxyCodeLine{00079\ }
\DoxyCodeLine{00080\ \textcolor{preprocessor}{\#if\ defined(QSC\_FALCON\_S3SHAKE256F512)}}
\DoxyCodeLine{00081\ }
\DoxyCodeLine{00086\ \textcolor{preprocessor}{\#\ \ \ define\ QSC\_FALCON\_PRIVATEKEY\_SIZE\ 1281}}
\DoxyCodeLine{00087\ }
\DoxyCodeLine{00092\ \textcolor{preprocessor}{\#\ \ \ define\ QSC\_FALCON\_PUBLICKEY\_SIZE\ 897}}
\DoxyCodeLine{00093\ }
\DoxyCodeLine{00098\ \textcolor{preprocessor}{\#\ \ \ define\ QSC\_FALCON\_SIGNATURE\_SIZE\ 658}}
\DoxyCodeLine{00099\ }
\DoxyCodeLine{00100\ \textcolor{preprocessor}{\#elif\ defined(QSC\_FALCON\_S5SHAKE256F1024)}}
\DoxyCodeLine{00101\ }
\DoxyCodeLine{00106\ \textcolor{preprocessor}{\#\ \ \ define\ QSC\_FALCON\_PRIVATEKEY\_SIZE\ 2305}}
\DoxyCodeLine{00107\ }
\DoxyCodeLine{00112\ \textcolor{preprocessor}{\#\ \ \ define\ QSC\_FALCON\_PUBLICKEY\_SIZE\ 1793}}
\DoxyCodeLine{00113\ }
\DoxyCodeLine{00118\ \textcolor{preprocessor}{\#\ \ \ define\ QSC\_FALCON\_SIGNATURE\_SIZE\ 1276}}
\DoxyCodeLine{00119\ }
\DoxyCodeLine{00120\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00121\ \textcolor{preprocessor}{\#\ \ \ error\ "{}The\ Falcon\ parameter\ set\ is\ invalid!"{}}}
\DoxyCodeLine{00122\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00123\ }
\DoxyCodeLine{00128\ \textcolor{preprocessor}{\#define\ QSC\_FALCON\_ALGNAME\ "{}FALCON"{}}}
\DoxyCodeLine{00129\ }
\DoxyCodeLine{00139\ QSC\_EXPORT\_API\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{falcon_8h_ad50c9f6d57a616047858b4e0d31f93b2}{qsc\_falcon\_generate\_keypair}}(uint8\_t*\ publickey,\ uint8\_t*\ privatekey,\ \textcolor{keywordtype}{bool}\ (*rng\_generate)(uint8\_t*,\ \textcolor{keywordtype}{size\_t}));}
\DoxyCodeLine{00140\ }
\DoxyCodeLine{00153\ QSC\_EXPORT\_API\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{falcon_8h_a37ede4bfd3a066d853f9d5cfb991ac41}{qsc\_falcon\_sign}}(uint8\_t*\ signedmsg,\ \textcolor{keywordtype}{size\_t}*\ smsglen,\ \textcolor{keyword}{const}\ uint8\_t*\ message,\ \textcolor{keywordtype}{size\_t}\ msglen,\ \textcolor{keyword}{const}\ uint8\_t*\ privatekey,\ \textcolor{keywordtype}{bool}\ (*rng\_generate)(uint8\_t*,\ \textcolor{keywordtype}{size\_t}));}
\DoxyCodeLine{00154\ }
\DoxyCodeLine{00165\ QSC\_EXPORT\_API\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{falcon_8h_a7d609dba718823e9ba023ca62864ce91}{qsc\_falcon\_verify}}(uint8\_t*\ message,\ \textcolor{keywordtype}{size\_t}*\ msglen,\ \textcolor{keyword}{const}\ uint8\_t*\ signedmsg,\ \textcolor{keywordtype}{size\_t}\ smsglen,\ \textcolor{keyword}{const}\ uint8\_t*\ publickey);}
\DoxyCodeLine{00166\ }
