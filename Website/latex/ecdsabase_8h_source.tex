\doxysection{ecdsabase.\+h}
\hypertarget{ecdsabase_8h_source}{}\label{ecdsabase_8h_source}\index{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/ecdsabase.h@{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/ecdsabase.h}}
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ }
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#ifndef\ QSC\_ECDSABASE\_H}}
\DoxyCodeLine{00042\ \textcolor{preprocessor}{\#define\ QSC\_ECDSABASE\_H}}
\DoxyCodeLine{00043\ }
...
\DoxyCodeLine{00047\ }
\DoxyCodeLine{00057\ \textcolor{keywordtype}{void}\ qsc\_ed25519\_keypair(uint8\_t*\ publickey,\ uint8\_t*\ privatekey,\ \textcolor{keyword}{const}\ uint8\_t*\ seed);}
\DoxyCodeLine{00058\ }
\DoxyCodeLine{00069\ int32\_t\ qsc\_ed25519\_sign(uint8\_t*\ signedmsg,\ \textcolor{keywordtype}{size\_t}*\ smsglen,\ \textcolor{keyword}{const}\ uint8\_t*\ message,\ \textcolor{keywordtype}{size\_t}\ msglen,\ \textcolor{keyword}{const}\ uint8\_t*\ privatekey);}
\DoxyCodeLine{00070\ }
\DoxyCodeLine{00081\ int32\_t\ qsc\_ed25519\_verify(uint8\_t*\ message,\ \textcolor{keywordtype}{size\_t}*\ msglen,\ \textcolor{keyword}{const}\ uint8\_t*\ signedmsg,\ \textcolor{keywordtype}{size\_t}\ smsglen,\ \textcolor{keyword}{const}\ uint8\_t*\ publickey);}
\DoxyCodeLine{00082\ }
\DoxyCodeLine{00083\ \textcolor{comment}{/*\ \(\backslash\)endcond\ DOXYGEN\_IGNORE\ */}}
\DoxyCodeLine{00084\ }
