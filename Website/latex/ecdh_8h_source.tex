\doxysection{ecdh.\+h}
\hypertarget{ecdh_8h_source}{}\label{ecdh_8h_source}\index{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/ecdh.h@{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/ecdh.h}}
\mbox{\hyperlink{ecdh_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ }
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#ifndef\ QSC\_ECDH\_H}}
\DoxyCodeLine{00042\ \textcolor{preprocessor}{\#define\ QSC\_ECDH\_H}}
\DoxyCodeLine{00043\ }
\DoxyCodeLine{00074\ }
\DoxyCodeLine{00075\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{common_8h}{common.h}}"{}}}
\DoxyCodeLine{00076\ }
\DoxyCodeLine{00081\ \textcolor{preprocessor}{\#\ \ \ define\ QSC\_ECDH\_PRIVATEKEY\_SIZE\ 32}}
\DoxyCodeLine{00082\ }
\DoxyCodeLine{00087\ \textcolor{preprocessor}{\#\ \ \ define\ QSC\_ECDH\_PUBLICKEY\_SIZE\ 32}}
\DoxyCodeLine{00088\ }
\DoxyCodeLine{00093\ \textcolor{preprocessor}{\#define\ QSC\_ECDH\_SHAREDSECRET\_SIZE\ 32}}
\DoxyCodeLine{00094\ }
\DoxyCodeLine{00099\ \textcolor{preprocessor}{\#define\ QSC\_ECDH\_SEED\_SIZE\ 32}}
\DoxyCodeLine{00100\ }
\DoxyCodeLine{00105\ \textcolor{preprocessor}{\#define\ QSC\_ECDH\_ALGNAME\ "{}ECDH"{}}}
\DoxyCodeLine{00106\ }
\DoxyCodeLine{00117\ QSC\_EXPORT\_API\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{ecdh_8h_acf8a0dd71a8090717a6958ee1b1103e5}{qsc\_ecdh\_key\_exchange}}(uint8\_t*\ secret,\ \textcolor{keyword}{const}\ uint8\_t*\ privatekey,\ \textcolor{keyword}{const}\ uint8\_t*\ publickey);}
\DoxyCodeLine{00118\ }
\DoxyCodeLine{00128\ QSC\_EXPORT\_API\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{ecdh_8h_aabc35fd16d6ad86406261a8df6c30d11}{qsc\_ecdh\_generate\_keypair}}(uint8\_t*\ publickey,\ uint8\_t*\ privatekey,\ \textcolor{keywordtype}{bool}\ (*rng\_generate)(uint8\_t*,\ \textcolor{keywordtype}{size\_t}));}
\DoxyCodeLine{00129\ }
\DoxyCodeLine{00139\ QSC\_EXPORT\_API\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{ecdh_8h_a63c73b113069f9817a50eb961f58a42d}{qsc\_ecdh\_generate\_seeded\_keypair}}(uint8\_t*\ publickey,\ uint8\_t*\ privatekey,\ \textcolor{keyword}{const}\ uint8\_t*\ seed);}
\DoxyCodeLine{00140\ }
