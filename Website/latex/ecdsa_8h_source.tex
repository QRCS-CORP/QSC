\doxysection{ecdsa.\+h}
\hypertarget{ecdsa_8h_source}{}\label{ecdsa_8h_source}\index{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/ecdsa.h@{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/ecdsa.h}}
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ }
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#ifndef\ QSC\_ECDSA\_H}}
\DoxyCodeLine{00042\ \textcolor{preprocessor}{\#define\ QSC\_ECDSA\_H}}
\DoxyCodeLine{00043\ }
\DoxyCodeLine{00044\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{common_8h}{common.h}}"{}}}
\DoxyCodeLine{00045\ }
\DoxyCodeLine{00083\ }
\DoxyCodeLine{00084\ \textcolor{preprocessor}{\#if\ defined(QSC\_ECDSA\_S1EC25519)}}
\DoxyCodeLine{00085\ }
\DoxyCodeLine{00090\ \textcolor{preprocessor}{\#\ \ \ define\ QSC\_ECDSA\_SIGNATURE\_SIZE\ 64}}
\DoxyCodeLine{00091\ }
\DoxyCodeLine{00096\ \textcolor{preprocessor}{\#\ \ \ define\ QSC\_ECDSA\_PRIVATEKEY\_SIZE\ 64}}
\DoxyCodeLine{00097\ }
\DoxyCodeLine{00102\ \textcolor{preprocessor}{\#\ \ \ define\ QSC\_ECDSA\_PUBLICKEY\_SIZE\ 32}}
\DoxyCodeLine{00103\ }
\DoxyCodeLine{00104\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00105\ \textcolor{preprocessor}{\#\ \ \ error\ "{}The\ ECDSA\ parameter\ set\ is\ invalid!"{}}}
\DoxyCodeLine{00106\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00107\ }
\DoxyCodeLine{00112\ \textcolor{preprocessor}{\#define\ QSC\_ECDSA\_SEED\_SIZE\ 32}}
\DoxyCodeLine{00113\ }
\DoxyCodeLine{00118\ \textcolor{preprocessor}{\#define\ QSC\_ECDSA\_ALGNAME\ "{}ECDSA"{}}}
\DoxyCodeLine{00119\ }
\DoxyCodeLine{00129\ QSC\_EXPORT\_API\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{ecdsa_8h_a5cb7019a87307acc6cabd32215bff2be}{qsc\_ecdsa\_generate\_seeded\_keypair}}(uint8\_t*\ publickey,\ uint8\_t*\ privatekey,\ \textcolor{keyword}{const}\ uint8\_t*\ seed);}
\DoxyCodeLine{00130\ }
\DoxyCodeLine{00140\ QSC\_EXPORT\_API\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{ecdsa_8h_acb610f9305bde8f9c0b86aa2681cee94}{qsc\_ecdsa\_generate\_keypair}}(uint8\_t*\ publickey,\ uint8\_t*\ privatekey,\ \textcolor{keywordtype}{bool}\ (*rng\_generate)(uint8\_t*,\ \textcolor{keywordtype}{size\_t}));}
\DoxyCodeLine{00141\ }
\DoxyCodeLine{00153\ QSC\_EXPORT\_API\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{ecdsa_8h_afc4a30cea712bf823fb6f9255cc78651}{qsc\_ecdsa\_sign}}(uint8\_t*\ signedmsg,\ \textcolor{keywordtype}{size\_t}*\ smsglen,\ \textcolor{keyword}{const}\ uint8\_t*\ message,\ \textcolor{keywordtype}{size\_t}\ msglen,\ \textcolor{keyword}{const}\ uint8\_t*\ privatekey);}
\DoxyCodeLine{00154\ }
\DoxyCodeLine{00165\ QSC\_EXPORT\_API\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{ecdsa_8h_af695383a08648a04c1ce7d039a3c2e18}{qsc\_ecdsa\_verify}}(uint8\_t*\ message,\ \textcolor{keywordtype}{size\_t}*\ msglen,\ \textcolor{keyword}{const}\ uint8\_t*\ signedmsg,\ \textcolor{keywordtype}{size\_t}\ smsglen,\ \textcolor{keyword}{const}\ uint8\_t*\ publickey);}
\DoxyCodeLine{00166\ }
