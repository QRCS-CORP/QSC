\doxysection{mceliecebase.\+h}
\hypertarget{mceliecebase_8h_source}{}\label{mceliecebase_8h_source}\index{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/mceliecebase.h@{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/mceliecebase.h}}
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ }
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#ifndef\ QSC\_MCELIECEBASE\_H}}
\DoxyCodeLine{00042\ \textcolor{preprocessor}{\#define\ QSC\_MCELIECEBASE\_H}}
\DoxyCodeLine{00043\ }
...
\DoxyCodeLine{00047\ }
\DoxyCodeLine{00048\ \textcolor{comment}{/*\ operations.h\ */}}
\DoxyCodeLine{00049\ }
\DoxyCodeLine{00058\ int32\_t\ qsc\_mceliece\_ref\_decapsulate(uint8\_t\ *key,\ \textcolor{keyword}{const}\ uint8\_t\ *c,\ \textcolor{keyword}{const}\ uint8\_t\ *sk);}
\DoxyCodeLine{00059\ }
\DoxyCodeLine{00069\ int32\_t\ qsc\_mceliece\_ref\_encapsulate(uint8\_t\ *c,\ uint8\_t\ *key,\ \textcolor{keyword}{const}\ uint8\_t\ *pk,\ \textcolor{keywordtype}{bool}\ (*rng\_generate)(uint8\_t*,\ \textcolor{keywordtype}{size\_t}));}
\DoxyCodeLine{00070\ }
\DoxyCodeLine{00081\ int32\_t\ qsc\_mceliece\_ref\_generate\_keypair(uint8\_t\ *pk,\ uint8\_t\ *sk,\ \textcolor{keywordtype}{bool}\ (*rng\_generate)(uint8\_t*,\ \textcolor{keywordtype}{size\_t}));}
\DoxyCodeLine{00082\ }
