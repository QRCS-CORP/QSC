\doxysection{ntrubase.\+h}
\hypertarget{ntrubase_8h_source}{}\label{ntrubase_8h_source}\index{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/ntrubase.h@{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/ntrubase.h}}
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ }
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#ifndef\ QSC\_NTRUBASE\_H}}
\DoxyCodeLine{00042\ \textcolor{preprocessor}{\#define\ QSC\_NTRUBASE\_H}}
\DoxyCodeLine{00043\ }
...
\DoxyCodeLine{00047\ }
\DoxyCodeLine{00048\ \textcolor{comment}{/*\ kem.h\ */}}
\DoxyCodeLine{00049\ }
\DoxyCodeLine{00058\ \textcolor{keywordtype}{bool}\ qsc\_ntru\_ref\_decapsulate(uint8\_t*\ ss,\ \textcolor{keyword}{const}\ uint8\_t*\ ct,\ \textcolor{keyword}{const}\ uint8\_t*\ sk);}
\DoxyCodeLine{00059\ }
\DoxyCodeLine{00068\ \textcolor{keywordtype}{void}\ qsc\_ntru\_ref\_encapsulate(uint8\_t*\ ct,\ uint8\_t*\ ss,\ \textcolor{keyword}{const}\ uint8\_t*\ pk,\ \textcolor{keywordtype}{bool}\ (*rng\_generate)(uint8\_t*,\ \textcolor{keywordtype}{size\_t}));}
\DoxyCodeLine{00069\ }
\DoxyCodeLine{00077\ \textcolor{keywordtype}{void}\ qsc\_ntru\_ref\_generate\_keypair(uint8\_t*\ pk,\ uint8\_t*\ sk,\ \textcolor{keywordtype}{bool}\ (*rng\_generate)(uint8\_t*,\ \textcolor{keywordtype}{size\_t}));}
\DoxyCodeLine{00078\ }
\DoxyCodeLine{00079\ \textcolor{comment}{/*\ \(\backslash\)endcond\ DOXYGEN\_IGNORE\ */}}
\DoxyCodeLine{00080\ }
