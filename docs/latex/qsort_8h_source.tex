\doxysection{qsort.\+h}
\hypertarget{qsort_8h_source}{}\label{qsort_8h_source}\index{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/qsort.h@{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/qsort.h}}
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ }
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#ifndef\ QSC\_QSORT\_H}}
\DoxyCodeLine{00042\ \textcolor{preprocessor}{\#define\ QSC\_QSORT\_H}}
\DoxyCodeLine{00043\ }
\DoxyCodeLine{00044\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{common_8h}{common.h}}"{}}}
\DoxyCodeLine{00045\ }
\DoxyCodeLine{00053\ QSC\_EXPORT\_API\ \textcolor{keywordtype}{void}\ qsc\_qsort\_sort\_i8(int8\_t*\ arr8,\ \textcolor{keywordtype}{int}\ start,\ \textcolor{keywordtype}{int}\ end);}
\DoxyCodeLine{00054\ }
\DoxyCodeLine{00062\ QSC\_EXPORT\_API\ \textcolor{keywordtype}{void}\ qsc\_qsort\_sort\_i16(int16\_t*\ arr16,\ \textcolor{keywordtype}{int}\ start,\ \textcolor{keywordtype}{int}\ end);}
\DoxyCodeLine{00063\ }
\DoxyCodeLine{00071\ QSC\_EXPORT\_API\ \textcolor{keywordtype}{void}\ qsc\_qsort\_sort\_i32(\textcolor{keywordtype}{int}*\ arr32,\ \textcolor{keywordtype}{int}\ start,\ \textcolor{keywordtype}{int}\ end);}
\DoxyCodeLine{00072\ }
\DoxyCodeLine{00080\ QSC\_EXPORT\_API\ \textcolor{keywordtype}{void}\ qsc\_qsort\_sort\_i64(int64\_t*\ arr64,\ int64\_t\ start,\ int64\_t\ end);}
\DoxyCodeLine{00081\ }
