...
\hypertarget{intrinsics_8h_source}{}\label{intrinsics_8h_source}\index{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/intrinsics.h@{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSC/QSC/intrinsics.h}}
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ }
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#ifndef\ QSC\_INTRINSICS\_H}}
\DoxyCodeLine{00042\ \textcolor{preprocessor}{\#define\ QSC\_INTRINSICS\_H}}
\DoxyCodeLine{00043\ }
\DoxyCodeLine{00044\ \textcolor{comment}{/*\ \(\backslash\)cond\ DOXYGEN\_IGNORE\ */}}
\DoxyCodeLine{00045\ }
\DoxyCodeLine{00050\ }
\DoxyCodeLine{00051\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{common_8h}{common.h}}"{}}}
\DoxyCodeLine{00052\ }
\DoxyCodeLine{00053\ \textcolor{preprocessor}{\#if\ defined(QSC\_SYSTEM\_COMPILER\_MSC)}}
\DoxyCodeLine{00054\ \textcolor{preprocessor}{\#\ \ \ if\ defined(QSC\_SYSTEM\_ARCH\_ARM)}}
\DoxyCodeLine{00055\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ include\ <arm\_neon.h>}}
\DoxyCodeLine{00056\ \textcolor{preprocessor}{\#\ \ \ else}}
\DoxyCodeLine{00057\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ include\ <intrin.h>}\ \ \textcolor{comment}{/*\ Microsoft\ C/C++\ compatible\ compiler\ */}}
\DoxyCodeLine{00058\ \textcolor{preprocessor}{\#\ \ \ endif}}
\DoxyCodeLine{00059\ \textcolor{preprocessor}{\#elif\ defined(\_\_GNUC\_\_)\ \&\&\ (defined(\_\_x86\_64\_\_)\ ||\ defined(\_\_i386\_\_))}}
\DoxyCodeLine{00060\ \textcolor{preprocessor}{\#\ \ \ include\ <x86intrin.h>}\ \ \ \textcolor{comment}{/*\ GCC-\/compatible\ compiler,\ targeting\ x86/x86-\/64\ */}}
\DoxyCodeLine{00061\ \textcolor{preprocessor}{\#elif\ defined(\_\_GNUC\_\_)\ \&\&\ defined(\_\_ARM\_NEON\_\_)}}
\DoxyCodeLine{00062\ \textcolor{preprocessor}{\#\ \ \ include\ <arm\_neon.h>}\ \ \ \ \textcolor{comment}{/*\ GCC-\/compatible\ compiler,\ targeting\ ARM\ with\ NEON\ */}}
\DoxyCodeLine{00063\ \textcolor{preprocessor}{\#elif\ defined(\_\_GNUC\_\_)\ \&\&\ defined(\_\_IWMMXT\_\_)}}
\DoxyCodeLine{00064\ \textcolor{preprocessor}{\#\ \ \ include\ <mmintrin.h>}\ \ \ \ \textcolor{comment}{/*\ GCC-\/compatible\ compiler,\ targeting\ ARM\ with\ WMMX\ */}}
\DoxyCodeLine{00065\ \textcolor{preprocessor}{\#elif\ (defined(\_\_GNUC\_\_)\ ||\ defined(\_\_xlC\_\_))\ \&\&\ (defined(\_\_VEC\_\_)\ ||\ defined(\_\_ALTIVEC\_\_))}}
\DoxyCodeLine{00066\ \textcolor{preprocessor}{\#\ \ \ include\ <altivec.h>}\ \ \ \ \ \textcolor{comment}{/*\ XLC\ or\ GCC-\/compatible\ compiler,\ targeting\ PowerPC\ with\ VMX/VSX\ */}}
\DoxyCodeLine{00067\ \textcolor{preprocessor}{\#elif\ defined(\_\_GNUC\_\_)\ \&\&\ defined(\_\_SPE\_\_)}}
\DoxyCodeLine{00068\ \textcolor{preprocessor}{\#\ \ \ include\ <spe.h>}\ \ \ \ \ \ \ \ \ \textcolor{comment}{/*\ GCC-\/compatible\ compiler,\ targeting\ PowerPC\ with\ SPE\ */}}
\DoxyCodeLine{00069\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00070\ }
\DoxyCodeLine{00071\ \textcolor{comment}{/*\ \(\backslash\)endcond\ DOXYGEN\_IGNORE\ */}}
\DoxyCodeLine{00072\ }
