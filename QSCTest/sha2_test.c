...
bool qsctest_sha2_256_kat()
{
	...
	qsc_sha2_compute256(otp, msg0, 0);
	...
	qsc_intutils_clear8(otp, sizeof(otp));
	qsc_sha2_compute256(otp, msg1, sizeof(msg1));
	...
	qsc_intutils_clear8(otp, sizeof(otp));
	qsc_sha2_compute256(otp, msg2, sizeof(msg2));
	...
	qsc_intutils_clear8(otp, sizeof(otp));
	qsc_sha2_compute256(otp, msg3, sizeof(msg3));
...
bool qsctest_sha2_384_kat()
{
	...
	qsc_sha2_compute384(otp, msg0, 0);
	...
	qsc_intutils_clear8(otp, sizeof(otp));
	qsc_sha2_compute384(otp, msg1, sizeof(msg1));
	...
	qsc_intutils_clear8(otp, sizeof(otp));
	qsc_sha2_compute384(otp, msg2, sizeof(msg2));
	...
	qsc_intutils_clear8(otp, sizeof(otp));
	qsc_sha2_compute384(otp, msg3, sizeof(msg3));
...
bool qsctest_sha2_512_kat()
{
	...
	qsc_sha2_compute512(otp, msg0, 0);
	...
	qsc_intutils_clear8(otp, sizeof(otp));
	qsc_sha2_compute512(otp, msg1, sizeof(msg1));
	...
	qsc_intutils_clear8(otp, sizeof(otp));
	qsc_sha2_compute512(otp, msg2, sizeof(msg2));
	...
	qsc_intutils_clear8(otp, sizeof(otp));
	qsc_sha2_compute512(otp, msg3, sizeof(msg3));
